-- Default keymaps for apple-music.nvim
-- Users can disable these by setting vim.g.apple_music_no_default_keymaps = true

if vim.g.apple_music_no_default_keymaps then
  return
end
